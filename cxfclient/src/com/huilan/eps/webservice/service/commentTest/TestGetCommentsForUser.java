...
public class TestGetCommentsForUser {
	private static JsonMapper jsonMapper = JsonMapper.buildNormalMapper();

	public static String getCommentsForUser(String loginPropertyJson, String userId,
		...
		// 需改动地方2
		String rs = webService.getCommentsForUser(loginPropertyJson, userId, pageNo, pageSize);
		return rs;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		String rs = getCommentsForUser(propertyJson, userId, pageNo, pageSize);
