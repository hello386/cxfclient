...
public class Article {
     ...
     * @return
     *     possible object is
     *     {@link Article.ResultMap }
     *     
     */
    public Article.ResultMap getResultMap() {
        return resultMap;
    }
     ...
     *     
     */
    public void setResultMap(Article.ResultMap value) {
    ...
    public static class ResultMap {
        ...
        protected List<Article.ResultMap.Entry> entry;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Article.ResultMap.Entry }
         * 
         * 
         */
        public List<Article.ResultMap.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<Article.ResultMap.Entry>();
            }
            return this.entry;
        }
