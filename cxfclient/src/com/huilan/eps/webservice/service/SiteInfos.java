...
/**
 * <p>siteInfos complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="siteInfos"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="siteList" type="{http://service.webservice.eps.huilan.com/}userMgrSite" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "siteInfos", propOrder = {
    "siteList",
    "status",
    "statusInfo"
})
public class SiteInfos {
    ...
    protected List<UserMgrSite> siteList;
     ...
     * 
     */
    public List<UserMgrSite> getSiteList() {
        if (siteList == null) {
            siteList = new ArrayList<UserMgrSite>();
        }
